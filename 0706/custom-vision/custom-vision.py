...
for domain in trainer.get_domains():
  print(domain.name, domain.id, domain.type)
  
publish_iteration_name = "sesac015-object-detection-v1"
...
# project = trainer.create_project("sesac015-customvision", domain_id=obj_detection_domain.id)
project_name = "sesac015-customvision"
discription = "포크와 가위를 감지하는 모델"
domain_id = None
has_project = None
